...
namespace Carmarket.Application.Identity.IS4.Data
{
    public class ApplicationDbContext : IdentityDbContext<CarmarketIdentityUser>
    {
        ...
        private void UsersSeed(ModelBuilder builder)
        {
            ...
            var alice = new CarmarketIdentityUser
            {
                Id = "1",
                UserName = "alice",
            ...
            alice.PasswordHash = new PasswordHasher<CarmarketIdentityUser>().HashPassword(alice, password);

            var bob = new CarmarketIdentityUser
            {
                Id = "2",
                UserName = "bob",
            ...
            bob.PasswordHash = new PasswordHasher<CarmarketIdentityUser>().HashPassword(bob, password);

            builder.Entity<CarmarketIdentityUser>()
                .HasData(alice, bob);
